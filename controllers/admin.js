...
router.post('/addEmp', [
    ...
    if(valError.length > 0){
        ...
        admin.addEmp(req.body.name, req.body.username, req.body.password, req.body.phone, req.body.gender, function(result){
...
router.post('/update/:id',[
    ...
    admin.getEmp(uID, function (result){
        ...
        if (valError.length > 0){
            ...
            admin.updEmp(uID, req.body.username, password, req.body.name, req.body.phone, req.body.gender, function(result1){
                res.redirect('/admin/allemplist');
            });
        }
    });    
